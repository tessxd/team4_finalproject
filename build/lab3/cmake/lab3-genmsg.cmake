...
message(STATUS "lab3: 0 messages, 1 services")
...
get_filename_component(_filename "/home/nvidia/catkin_ws/src/lab3/srv/GetPlan.srv" NAME_WE)
add_custom_target(_lab3_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lab3" "/home/nvidia/catkin_ws/src/lab3/srv/GetPlan.srv" ""
)
...
_generate_srv_cpp(lab3
  "/home/nvidia/catkin_ws/src/lab3/srv/GetPlan.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab3)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab3\")")
  # install generated code
  install(
